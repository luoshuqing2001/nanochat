...
parser.add_argument("--attn-kind", type=str, default="softmax", choices=["softmax", "softplus"], help="attention score map: softmax (FA3/FA4/SDPA) or softplus (elementwise, unnormalised, Triton kernel in nanochat/softplus_attention.py)")
