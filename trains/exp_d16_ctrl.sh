#!/usr/bin/env bash
# =============================================================================
# Ablation: d16 hybrid SWA + Muon, 12.0B tokens, FP8.
#
#   bash trains/exp_d16_ctrl.sh                        # moonlight arm
#   MUON_VARIANT=nanochat bash trains/exp_d16_ctrl.sh   # baseline arm
#   RESUME=<run_id> bash trains/exp_d16_ctrl.sh         # continue after a container restart
...
#   12.0B tokens = 22 per parameter, ~22,848 steps, about 5.6 h on one B200
