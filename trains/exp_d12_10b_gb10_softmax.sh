#!/usr/bin/env bash
# =============================================================================
# d12 hybrid SWA + Muon, 10.0B tokens, on ONE GB10 (DGX Spark), attention: softmax.
#
#   DRY_RUN=1 bash trains/exp_d12_10b_gb10_softmax.sh               # print the config, do not train
#   SMOKE=1 bash trains/exp_d12_10b_gb10_softmax.sh                 # 20-step pipeline check, gives tok/s
#   bash trains/exp_d12_10b_gb10_softmax.sh                         # moonlight arm
#   MUON_VARIANT=nanochat bash trains/exp_d12_10b_gb10_softmax.sh   # baseline arm
#   RESUME=<run_id> bash trains/exp_d12_10b_gb10_softmax.sh         # continue after a crash / restart
#
