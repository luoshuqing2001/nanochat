#!/usr/bin/env bash
# =============================================================================
# d12 hybrid SWA + Muon, 4.0B tokens, on ONE GB10 (DGX Spark), attention: softplus_rmsnorm.
#
#   DRY_RUN=1 bash trains/exp_d12_4b_gb10_softplus_rmsnorm.sh               # print the config, do not train
#   SMOKE=1 bash trains/exp_d12_4b_gb10_softplus_rmsnorm.sh                 # 20-step pipeline check, gives tok/s
#   bash trains/exp_d12_4b_gb10_softplus_rmsnorm.sh                         # moonlight arm
#   MUON_VARIANT=nanochat bash trains/exp_d12_4b_gb10_softplus_rmsnorm.sh   # baseline arm
#   RESUME=<run_id> bash trains/exp_d12_4b_gb10_softplus_rmsnorm.sh         # continue after a crash / restart
#
